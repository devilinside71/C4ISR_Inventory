...
Sub AddRibbonLineC4ISR()
  ...
  On Error Resume Next
  Set cbToolBar = Application.CommandBars.Add(sToolbarC4ISR, msoBarTop, False, _
        True)
  With cbToolBar
...
Sub AddRibbonLineLang()
  ...
  On Error Resume Next
  Set cbToolBar = Application.CommandBars.Add(sToolbarLang, msoBarTop, False, _
        True)
  With cbToolBar
    Set ctButton1 = .Controls.Add(Type:=msoControlButton, ID:=2950)
    Set ctButton2 = .Controls.Add(Type:=msoControlButton, ID:=2950)
...
Sub AddRibbonLineC4ISRFile()
  ...
  On Error Resume Next
  Set cbToolBar = Application.CommandBars.Add(sToolbarC4ISRFile, msoBarTop, _
        False, True)
  With cbToolBar
    Set ctButton1 = .Controls.Add(Type:=msoControlButton, ID:=2950)
    Set ctButton2 = .Controls.Add(Type:=msoControlButton, ID:=2950)
