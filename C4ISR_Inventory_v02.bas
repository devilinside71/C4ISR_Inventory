...
Sub SetPlattform()
  #If Mac Then
    isMacOS = True
    isWindows = False
    Call clLogger.logINFO("OS: MacOS", "Sub:SetPlattform")
  #Else
    isMacOS = False
    isWindows = True
    Call clLogger.logINFO("OS: Windows", "Sub:SetPlattform")
  #End If
  #If Win64 Then
    Is64BitOffice = True
    Call clLogger.logINFO("Office: 64bit", "Sub:SetPlattform")
  #Else
    Is64BitOffice = False
    #If Mac Then
      Call clLogger.logINFO("Office: MacOS", "Sub:SetPlattform")
    #Else
      Call clLogger.logINFO("Office: 32bit", "Sub:SetPlattform")
    #End If
  #End If
  mbDebugMode = True
End Sub
...
PROC_ERR:
    ...
    If Err.Number Then
        Call clLogger.logERROR(Err.Description, "Sub:C4ISR_Inventory")
    End If
    Resume PROC_EXIT
End Sub
...
Private Sub Add2FullInventory(Path2ADSInventoryFile As String)
  ...
  If mbDebugMode Then
    Call clLogger.logDEBUG("Last row of " & cmshFullInventory & " sheet: " & lLastRowFullInventory, "Add2FullInventory")
  End If
  ...
  For Each ws In wbkADSInventory.Worksheets
    ...
    End If
  Next
  Call clLogger.logINFO("Inventory sheet name: " & shInventorySheet, "Add2FullInventory")
  
  sPackageName = ScanForPackageName(wbkADSInventory)
  If mbDebugMode Then
    Call clLogger.logDEBUG("Package name: " & sPackageName, "Add2FullInventory")
  End If
  ...
  If Not bNotInTheList Then
    If mbDebugMode Then
      Call clLogger.logDEBUG("Interrupted because " & sPackageName & " is in the list.", "Add2FullInventory")
    End If
    GoTo PROC_EXIT
  End If
...
PROC_ERR:
  ...
  If Err.Number Then
    Call clLogger.logERROR(Err.Description, "Sub:Add2FullInventory")
  End If
  Resume PROC_EXIT
End Sub
...
Private Sub Add2Inventory(Path2ADSInventoryFile As String)
  ...
  Next
  If mbDebugMode Then
    Call clLogger.logDEBUG("Inventory sheet name: " & shInventorySheet, "Add2Inventory")
  End If
...
PROC_ERR:
  Debug.Print "Error in Procedure Add2FullInventory"
  If Err.Number Then
    Call clLogger.logERROR(Err.Description, "Sub:Add2Inventory")
  End If
  Resume PROC_EXIT
End Sub
...
FUNC_ERROR:
  ...
  If Err.Number Then
    Call clLogger.logERROR(Err.Description, "Func:DeleteInventory")
  End If
  Resume FUNC_EXIT
End Function
...
FUNC_ERR:
    ...
    If Err.Number Then
        Call clLogger.logERROR(Err.Description, "Func:GetPath2Inventory")
    End If
    Resume FUNC_EXIT
End Function
...
FUNC_ERR:
  ...
  If Err.Number Then
    Call clLogger.logERROR(Err.Description, "Func:ScanForPackageName")
  End If
  Resume FUNC_EXIT
End Function
...
Private Sub DeleteScannedData()
  ...
  If Not bDelete Then
    If mbDebugMode Then
      Call clLogger.logDEBUG("Delete scanned data has been interrupted because scanned data was not deleted.", "Sub:DeleteScannedData")
    End If
    GoTo PROC_EXIT
  End If
...
PROC_ERR:
  ...
  If Err.Number Then
      Call clLogger.logERROR(Err.Description, "Sub:DeleteScannedData")
  End If
  Resume PROC_EXIT
End Sub
...
FUNC_ERR:
  ...
  If Err.Number Then
    Call clLogger.logERROR(Err.Description, "Func:DeleteScan")
  End If
  Resume FUNC_EXIT
End Function
Sub ReadFromFile()
  ...
  If Not bDelete Then
    If mbDebugMode Then
      Call clLogger.logDEBUG("Read from file has been interrupted because scanned data was not deleted.", "ReadFromFile")
    End If
    GoTo PROC_EXIT
  End If
  i = 1
...
PROC_ERR:
  ...
  If Err.Number Then
    Call clLogger.logERROR(Err.Description, "Sub:ReadFromFile")
  End If
  Resume PROC_EXIT
End Sub
